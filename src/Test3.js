...
export default function Test3(props) {
  ...
  return (
    ...
    >
      ...
      {/* Physicsで物理エンジンを適用 */}
      <Physics /*debug*/ gravity={[0, 0, 0]} debug={true}>
        {/* ポインター */}
        <Pointer />
...
function Connector({
  ...
  useFrame((state, delta) => {
    ...
    const centerOffset = new THREE.Vector3(1.8, 0, 0); // X方向に +1 ずらす
  ...
  return (
    ...
    >
      ...
      />
      {/* <TrimeshCollider args={[api.選択範囲.geometry]} /> */}
...
function Model({ children, color = "white", roughness = 0, ...props }) {
  ...
  return (
    <mesh
      ...
      //   rotation={[90, 0, 0]}
    >
      {/* <TrimeshCollider args={[nodes.mesh.geometry]} /> */}
      {/* マテリアル設定 */}
